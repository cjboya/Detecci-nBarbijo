...
LABELS = ["Con_Barbijo", "Sin_Barbijo"]

# Leer el modelo
face_mask = cv2.face.LBPHFaceRecognizer_create()
face_mask.read(r"C:\Users\Distancia\Desktop\Proyectos\proyecto reconocimiento de rostros\face_mask_model.xml")
     ...
     while True:
          ...
          if results.detections is not None:
               for detection in results.detections:
                    ...
                    if result[1] < 150:
                         color = (0, 255, 0) if LABELS[result[0]] == "Con_Barbijo" else (0, 0, 255)
